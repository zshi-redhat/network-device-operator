...
import (
	...
	"github.com/zshi-redhat/network-device-operator/pkg/client/clientset/versioned/scheme"
...
type NetdevV1alpha1Client struct {
	restClient rest.Interface
}
...
func NewForConfig(c *rest.Config) (*NetdevV1alpha1Client, error) {
	config := *c
	...
	return &NetdevV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new NetdevV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *NetdevV1alpha1Client {
...
// New creates a new NetdevV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *NetdevV1alpha1Client {
	return &NetdevV1alpha1Client{c}
}
...
func (c *NetdevV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
